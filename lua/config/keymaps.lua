...
if vim.g.vscode == 1 then
    ...
    return function()
      ...
      for _, o in ipairs(args) do
        ...
        elseif o_ty == "table" then
          ...
          vim.notify(
            "invalid type " .. o_ty .. " of vscode args: " .. vim.inspect(o),
  ...
  keymaps(
    "n",
    "<leader>fp",
    vsc_actions("workbench.action.openRecent"),
    { desc = "File: Open Recent" }
  )

  keymaps(
    "n",
    "<leader>cr",
    vsc_actions("editor.action.rename"),
    { desc = "Rename" }
  )
  keymaps(
    "n",
    "<leader>cf",
    vsc_actions("editor.action.formatDocument"),
    { desc = "format" }
  )
  keymaps(
    "n",
    "<leader>ca",
    vsc_actions("editor.action.quickFix"),
    { desc = "code action" }
  )
  keymaps(
    "n",
    "<leader>cs",
    vsc_actions("outline.toggleVisibility"),
    { desc = "toggle outline" }
  )
  keymaps(
    "n",
    "<leader>co",
    vsc_actions("editor.action.organizeImports"),
  ...
  keymaps(
    "n",
    "<leader>sg",
    vsc_actions("workbench.action.findInFiles"),
    { desc = "Find in Files" }
  )
  -- 调用vscode命令 <C-S-p>
  keymaps(
    "n",
    "<leader>sc",
    vsc_actions("workbench.action.showCommands"),
    { desc = "Show All Commands" }
  )
  keymaps(
    "n",
    "<leader>sS",
    vsc_actions("workbench.action.showAllSymbols"),
  ...
  keymaps(
    "n",
    "<leader>bd",
    vsc_actions("workbench.action.closeActiveEditor"),
    { desc = "Close window" }
  )
  keymaps(
    "n",
    "<leader>bo",
    vsc_actions("workbench.action.closeOtherEditors"),
  ...
  keymaps(
    "n",
    "gI",
    vsc_actions("editor.action.goToImplementation"),
  ...
  keymaps(
    "n",
    "<leader>uC",
    vsc_actions("workbench.action.selectTheme"),
    { desc = "Preferences: Color Theme" }
  )
  keymaps(
    "n",
    "<leader>uw",
    vsc_actions("editor.action.toggleWordWrap"),
    { desc = "View: Toggle Word Wrap" }
  )
  keymaps(
    "n",
    "<leader>ub",
  ...
  keymaps(
    { "n", "v" },
    "<leader>ge",
    vsc_actions("workbench.view.scm"),
    { desc = "View: Show Changes" }
  )
